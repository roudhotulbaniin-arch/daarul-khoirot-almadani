...
// Guard: cegah declared 2x kalau file ke-load dobel
if (typeof window.SwalPremium === "undefined") {

    window.SwalPremium = (function() {
    ...
    console.log("✅ SwalPremium ready");

} else {
    console.warn("⚠️ SwalPremium sudah ada, skip re-declaration");
}